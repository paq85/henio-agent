...
# Minimum context length required to run Henio Agent.  Models with fewer
...
DEFAULT_CONTEXT_LENGTHS = {
    ...
    # so these hardcoded fallbacks prevent Henio from probing-down to
...
def _get_context_cache_path() -> Path:
    ...
    return get_henio_home() / "context_length_cache.yaml"
...
def estimate_request_tokens_rough(
    ...
    *,
    ...
    Includes the major payload buckets Henio sends to providers:
