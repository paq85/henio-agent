...
class MemoryProvider(ABC):
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        kwargs always include:
          - henio_home (str): The active HENIO_HOME directory path. Use this
            for profile-scoped storage instead of hardcoding ``~/.henio``.
        ...
        kwargs may also include:
          ...
          - agent_workspace (str): Shared workspace name (e.g. "henio").
    ...
    def get_config_schema(self) -> List[Dict[str, Any]]:
        ...
        Used by 'henio memory setup' to walk the user through configuration.
    ...
    def save_config(self, values: Dict[str, Any], henio_home: str) -> None:
        """Write non-secret config to the provider's native location.

        Called by 'henio memory setup' after collecting user inputs.
        ``values`` contains only non-secret fields (secrets go to .env).
        ``henio_home`` is the active HENIO_HOME directory path.
