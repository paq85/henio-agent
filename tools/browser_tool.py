...
def _socket_safe_tmpdir() -> str:
    ...
    append ``agent-browser-henio_…`` the resulting socket path exceeds the
...
def _find_agent_browser() -> str:
    ...
    Checks in order: current PATH, Homebrew/common bin dirs, Henio-managed
    ...
    # Build an extended search PATH including Homebrew and Henio-managed dirs.
    ...
    henio_node_bin = str(henio_home / "node" / "bin")
    if os.path.isdir(henio_node_bin):
        extra_dirs.append(henio_node_bin)
...
def _run_browser_command(
    ...
    try:
        ...
        # Ensure PATH includes Henio-managed Node first, Homebrew versioned
...
def _maybe_start_recording(task_id: str):
    ...
    try:
        ...
        recordings_dir = henio_home / "browser_recordings"
...
def browser_vision(question: str, annotate: bool = False, task_id: Optional[str] = None) -> str:
    ...
    screenshots_dir = get_henio_dir("cache/screenshots", "browser_screenshots")
