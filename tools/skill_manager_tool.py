...
~/.henio/skills/. Existing skills (bundled, hub-installed, or user-created)
...
# All skills live in ~/.henio/skills/ (single source of truth)
...
def _find_skill(name: str) -> Optional[Dict[str, Any]]:
    ...
    Searches the local skills dir (~/.henio/skills/) first, then any
...
SKILL_MANAGE_SCHEMA = {
    ...
    "description": (
        ...
        "New skills go to ~/.henio/skills/; existing skills can be modified wherever they live.\n\n"
