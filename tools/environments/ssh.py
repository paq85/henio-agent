...
class SSHEnvironment(BaseEnvironment):
    ...
    def __init__(self, host: str, user: str, cwd: str = "~",
        ...
        self.control_dir = Path(tempfile.gettempdir()) / "henio-ssh"
        ...
        self._sync_manager = FileSyncManager(
            get_files_fn=lambda: iter_sync_files(f"{self._remote_home}/.henio"),
    ...
    def _ensure_remote_dirs(self) -> None:
        """Create base ~/.henio directory tree on remote in one SSH call."""
        base = f"{self._remote_home}/.henio"
    ...
    def _ssh_bulk_upload(self, files: list[tuple[str, str]]) -> None:
        ...
        with tempfile.TemporaryDirectory(prefix="henio-ssh-bulk-") as staging:
