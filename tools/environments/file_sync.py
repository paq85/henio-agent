...
_FORCE_SYNC_ENV = "HENIO_FORCE_FILE_SYNC"
...
def iter_sync_files(container_base: str = "/root/.henio") -> list[tuple[str, str]]:
    ...
    the hardcoded /root/.henio to *container_base* because the remote
...
class FileSyncManager:
    ...
    def sync(self, *, force: bool = False) -> None:
        ...
        or ``HENIO_FORCE_FILE_SYNC=1`` is set.
