...
Trust levels:
  - builtin:   Ships with Henio. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.henio/\.env|\~/\.henio/\.env',
     "henio_env_access", "critical", "exfiltration",
     "directly references Henio secrets file"),
    ...
    (r'\.henio/config\.yaml|\.henio/SOUL\.md',
     "henio_config_mod", "critical", "persistence",
     "references Henio configuration files directly"),
...
def _get_configured_model() -> str:
    """Load the user's configured model from ~/.henio/config.yaml."""
    try:
