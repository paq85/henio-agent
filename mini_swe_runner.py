#!/usr/bin/env python3
"""
SWE Runner with Henio Trajectory Format

A runner that uses Henio-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the Henio-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses Henio-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in Henio format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches Henio-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using Henio-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with Henio Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses Henio-Agent's built-in execution environments
    and outputs trajectories in Henio-Agent format.
    """
    ...
    def _convert_to_henio_format(
        ...
        """
        Convert internal message format to Henio trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to Henio trajectory format
        trajectory = self._convert_to_henio_format(messages, task, completed)
...
def main(
    ...
    """
    Run SWE tasks with Henio trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with Henio Trajectory Format")
    print("=" * 60)
