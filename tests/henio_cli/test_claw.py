...
from henio_cli import claw as claw_mod
...
class TestPrintMigrationReport:
    ...
    def test_dry_run_report(self, capsys):
        report = {
            ...
            "items": [
                {"kind": "soul", "status": "migrated", "destination": "/home/user/.henio/SOUL.md"},
                {"kind": "memory", "status": "migrated", "destination": "/home/user/.henio/memories/MEMORY.md"},
    ...
    def test_execute_report(self, capsys):
        report = {
            ...
            "output_dir": "/home/user/.henio/migration/openclaw/20250312T120000",
        }
