"""Tests for the interactive session browser (`henio sessions browse`).
...
from henio_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """henio sessions browse should be parseable."""
        from henio_cli.main import main as _main_entry
