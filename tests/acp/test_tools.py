...
COMMON_HENIO_TOOLS = ["read_file", "search_files", "terminal", "patch", "write_file", "process"]


class TestToolKindMap:
    def test_all_henio_tools_have_kind(self):
        """Every common henio tool should appear in TOOL_KIND_MAP."""
        for tool in COMMON_HENIO_TOOLS:
