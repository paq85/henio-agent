...
class TestParserRegistry:
    ...
    def test_henio_parser_registered(self):
        parsers = list_parsers()
        assert "henio" in parsers
...
class TestHenioParser:
    @pytest.fixture
    def parser(self):
        return get_parser("henio")
...
class TestParseResultContract:
    ...
    @pytest.fixture(params=["henio"])  # Add more as needed
    ...
    def test_tool_calls_are_proper_objects(self, parser):
        ...
        # Use henio format since that's universal
