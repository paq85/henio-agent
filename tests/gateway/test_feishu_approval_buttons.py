...
class TestFeishuExecApproval:
    ...
    async def test_sends_interactive_card(self):
        ...
        action_names = [a["value"]["henio_action"] for a in actions]
        assert action_names == [
...
class TestFeishuApprovalCallback:
    ...
    async def test_resolves_approval_on_click(self):
        ...
        data = _make_card_action_data(
            action_value={"henio_action": "approve_once", "approval_id": 1},
        )
    ...
    async def test_deny_button(self):
        ...
        data = _make_card_action_data(
            action_value={"henio_action": "deny", "approval_id": 2},
            token="tok_deny",
        )
    ...
    async def test_session_approval(self):
        ...
        data = _make_card_action_data(
            action_value={"henio_action": "approve_session", "approval_id": 3},
            token="tok_ses",
        )
    ...
    async def test_always_approval(self):
        ...
        data = _make_card_action_data(
            action_value={"henio_action": "approve_always", "approval_id": 4},
            token="tok_alw",
        )
    ...
    async def test_already_resolved_drops_silently(self):
        ...
        data = _make_card_action_data(
            action_value={"henio_action": "approve_once", "approval_id": 99},
            token="tok_gone",
        )
