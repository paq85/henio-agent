...
class TestToolsetConsistency:
    ...
    def test_henio_platforms_share_core_tools(self):
        """All henio-* platform toolsets should have the same tools."""
        platforms = ["henio-cli", "henio-telegram", "henio-discord", "henio-whatsapp", "henio-slack", "henio-signal", "henio-homeassistant"]
