...
def _reload_constants():
    """Reload henio_constants to get a fresh apply_ipv4_preference."""
    import henio_constants
    importlib.reload(henio_constants)
    return henio_constants
...
class TestApplyIPv4Preference:
    ...
    def test_patches_getaddrinfo_when_forced(self):
        ...
        assert getattr(socket.getaddrinfo, "_henio_ipv4_patched", False) is True
