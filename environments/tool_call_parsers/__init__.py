...
def register_parser(name: str):
    ...
    Usage:
        @register_parser("henio")
        class HenioToolCallParser(ToolCallParser):
            ...
    """
...
def get_parser(name: str) -> ToolCallParser:
    ...
    Args:
        name: Parser name (e.g., "henio", "mistral", "llama3_json")
...
from environments.tool_call_parsers.henio_parser import HenioToolCallParser  # noqa: E402, F401
