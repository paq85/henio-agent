...
Inspired by: GroceryMind — production Henio agent doing live web research
             across German grocery stores (firecrawl + henio-agent)
"""
...
# Ensure henio-agent root is on path
...
class WebResearchEnvConfig(HenioAgentEnvConfig):
...
class WebResearchEnv(HenioAgentBaseEnv):
    """
