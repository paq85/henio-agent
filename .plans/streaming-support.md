# Streaming LLM Response Support for Henio Agent
...
```
HENIO_STREAMING_ENABLED=true    # Master switch via env
```
...
try:
    ...
    pass
# Env var override
if os.getenv("HENIO_STREAMING_ENABLED", "").lower() in ("true", "1", "yes"):
...
| `henio_cli/config.py` | 1 | +streaming config defaults |
