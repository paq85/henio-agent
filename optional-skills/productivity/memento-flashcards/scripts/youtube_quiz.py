...
The quiz question generation is done by the agent; this script only fetches transcripts.
"""
...
def cmd_fetch(args: argparse.Namespace) -> None:
    ...
    segments = raw.to_raw_data() if hasattr(raw, "to_raw_data") else raw
    ...
    _out({"ok": True, "video_id": video_id, "transcript": text})
