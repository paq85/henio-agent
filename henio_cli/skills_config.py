"""
Skills configuration for Henio Agent.
`henio skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.henio/config.yaml under:
...
from henio_cli.platforms import PLATFORMS as _PLATFORMS, platform_label
