...
Usage:
    henio pairing list              # Show all pending + approved users
    henio pairing approve <platform> <code>  # Approve a pairing code
    henio pairing revoke <platform> <user_id> # Revoke user access
    henio pairing clear-pending     # Clear all expired/pending codes
"""

def pairing_command(args):
    """Handle henio pairing subcommands."""
    ...
    if action == "list":
        ...
        print("Usage: henio pairing {list|approve|revoke|clear-pending}")
        print("Run 'henio pairing --help' for details.")
...
def _cmd_approve(store, platform: str, code: str):
    ...
    if result:
        ...
        print("  Run 'henio pairing list' to see pending codes.\n")
