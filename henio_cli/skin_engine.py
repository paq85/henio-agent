"""Henio CLI skin/theme engine.

A data-driven skin system that lets users customize the CLI's visual appearance.
Skins are defined as YAML files in ~/.henio/skins/ (or legacy ~/.henio/skins/)
or as built-in presets.
...
.. code-block:: yaml
    ...
    branding:
    agent_name: "Henio Agent"           # Banner title, status display
      welcome: "Welcome message"          # Shown at CLI startup
      goodbye: "Goodbye! ⚕"              # Shown on exit
    response_label: " ⚕ Henio "        # Response box header label
...
.. code-block:: python
    ...
    from henio_cli.skin_engine import get_active_skin, list_skins, set_active_skin

    skin = get_active_skin()
    print(skin.colors["banner_title"])    # "#FFD700"
    print(skin.get_branding("agent_name"))  # "Henio Agent"

    set_active_skin("ares")               # Switch to built-in ares skin
    set_active_skin("mytheme")            # Switch to user skin from ~/.henio/skins/
...
Drop a YAML file in ``~/.henio/skins/<name>.yaml`` following the schema above.
...
class SkinConfig:
    ...
    banner_logo: str = ""    # Rich-markup ASCII art logo (replaces HENIO_AGENT_LOGO)
    banner_hero: str = ""    # Rich-markup hero art (replaces HENIO_CADUCEUS)
...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        "name": "default",
        "description": "Classic Henio — gold and kawaii",
        "colors": {
        ...
        "branding": {
            "agent_name": "Henio Agent",
            "welcome": "Welcome to Henio Agent! Type your message or /help for commands.",
            "goodbye": "Goodbye! ⚕",
            "response_label": " ⚕ Henio ",
            "prompt_symbol": "❯ ",
