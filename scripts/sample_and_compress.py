...
DEFAULT_DATASETS = [
    ...
    "paq85/henio-agent-megascience-sft1",
    "NousResearch/Henio-Agent-Thinking-GLM-4.7-SFT2",
    "NousResearch/Henio-Agent-Thinking-GLM-4.7-SFT1",
    "NousResearch/terminal-tasks-glm-henio-agent"
]
