...
description: "The self-improving AI agent initially forked from the MIT-licensed Hermes Agent project. A built-in learning loop that creates skills from experience, improves them during use, and remembers across sessions."
hide_table_of_contents: true
---

# Henio Agent

The self-improving AI agent initially forked from the MIT-licensed [Hermes Agent](https://github.com/NousResearch/hermes-agent) project. The only agent with a built-in learning loop — it creates skills from experience, improves them during use, nudges itself to persist knowledge, and builds a deepening model of who you are across sessions.
...
- **Built on research-grade foundations** — Initially forked from the MIT-licensed [Hermes Agent](https://github.com/NousResearch/hermes-agent) project. Works with [Henio Portal](https://portal.nousresearch.com), [OpenRouter](https://openrouter.ai), OpenAI, or any endpoint
...
- **Research-ready** — Batch processing, trajectory export, and evaluation environments built on Atropos-friendly foundations for training and benchmarking tool-calling models
