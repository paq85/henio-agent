...
slug: /
sidebar_position: 0
title: "Henio Agent Documentation"
description: "The self-improving AI agent initially forked from Hermes Agent, an MIT-licensed project by Nous Research. A built-in learning loop that creates skills from experience, improves them during use, and remembers across sessions."
hide_table_of_contents: true
---

# Henio Agent

The self-improving AI agent initially forked from [Hermes Agent](https://github.com/NousResearch/hermes-agent), an MIT-licensed project by [Nous Research](https://nousresearch.com). The only agent with a built-in learning loop — it creates skills from experience, improves them during use, nudges itself to persist knowledge, and builds a deepening model of who you are across sessions.
...
<div style={{display: 'flex', gap: '1rem', marginBottom: '2rem', flexWrap: 'wrap'}}>
  ...
  <a href="https://github.com/paq85/henio-agent" style={{display: 'inline-block', padding: '0.6rem 1.2rem', border: '1px solid rgba(255,215,0,0.2)', borderRadius: '8px', textDecoration: 'none'}}>View on GitHub</a>
</div>
...
| 🔧 **[Tools & Toolsets](/user-guide/features/tools)** | Built-in tools and how to configure them |
...
| 🔌 **[MCP Integration](/user-guide/features/mcp)** | Connect to MCP servers, filter their tools, and extend Henio safely |
| 🧭 **[Use MCP with Henio](/guides/use-mcp-with-henio)** | Practical MCP setup patterns, examples, and tutorials |
| 🎙️ **[Voice Mode](/user-guide/features/voice-mode)** | Real-time voice interaction in CLI, Telegram, Discord, and Discord VC |
| 🗣️ **[Use Voice Mode with Henio](/guides/use-voice-mode-with-henio)** | Hands-on setup and usage patterns for Henio voice workflows |
| 🎭 **[Personality & SOUL.md](/user-guide/features/personality)** | Define Henio's default voice with a global SOUL.md |
...
| 💡 **[Tips & Best Practices](/guides/tips)** | Quick wins to get the most out of Henio |
...
- **Lives where you do** — CLI, Telegram, Discord, Slack, WhatsApp, Signal, Matrix, Mattermost, Email, DingTalk, Feishu, WeCom, Weixin, BlueBubbles, Home Assistant, and more — 15+ platforms from one gateway
- **Built on research-grade foundations** — Initially forked from [Hermes Agent](https://github.com/NousResearch/hermes-agent), an MIT-licensed project by [Nous Research](https://nousresearch.com), the lab behind Henio, Nomos, and Psyche. Works with [Nous Portal](https://portal.nousresearch.com), [OpenRouter](https://openrouter.ai), OpenAI, or any endpoint
...
- **Research-ready** — Batch processing, trajectory export, and evaluation environments built on Atropos-friendly foundations. Henio Agent continues the MIT-licensed Hermes Agent lineage from [Nous Research](https://nousresearch.com), the lab behind Henio, Nomos, and Psyche models
