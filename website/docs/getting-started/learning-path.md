...
sidebar_position: 3
title: 'Learning Path'
description: 'Choose your learning path through the Henio Agent documentation based on your experience level and goals.'
---

# Learning Path

Henio Agent can do a lot — CLI assistant, Telegram/Discord bot, task automation, evaluation workflows, and more. This page helps you figure out where to start and what to read based on your experience level and what you're trying to accomplish.

:::tip Start Here
If you haven't installed Henio Agent yet, begin with the [Installation guide](/docs/getting-started/installation) and then run through the [Quickstart](/docs/getting-started/quickstart). Everything below assumes you have a working installation.
:::
...
- **Just browsing?** Check the [Key Features](#key-features-at-a-glance) table for a quick overview of everything Henio Agent can do.
...
| **Advanced** | Build custom tools, create skills, run evaluation workflows, contribute to the project | [Architecture](/docs/developer-guide/architecture) → [Adding Tools](/docs/developer-guide/adding-tools) → [Creating Skills](/docs/developer-guide/creating-skills) → [Environments](/docs/developer-guide/environments) → [Contributing](/docs/developer-guide/contributing) | ~4–6 hours |
...
Use Henio Agent as an interactive terminal assistant for writing, reviewing, and running code.
...
:::tip
Pass files directly into your conversation with context files. Henio Agent can read, edit, and run code in your projects.
:::

### "I want a Telegram/Discord bot"

Deploy Henio Agent as a bot on your favorite messaging platform.
...
7. [Use Voice Mode with Henio](/docs/guides/use-voice-mode-with-henio)
...
:::tip
Cron jobs let Henio Agent run tasks on a schedule — daily summaries, periodic checks, automated reports — without you being present.
:::

### "I want to build custom tools/skills"

Extend Henio Agent with your own tools and reusable skill packages.
...
### "I want to run evaluations or generate trajectories"

Use Henio Agent's environment framework and batch tooling to benchmark workflows, collect trajectory data, and experiment with evaluation loops.

1. [Quickstart](/docs/getting-started/quickstart)
2. [Configuration](/docs/user-guide/configuration)
3. [Batch Processing](/docs/user-guide/features/batch-processing)
4. [Environments](/docs/developer-guide/environments)
5. [Architecture](/docs/developer-guide/architecture)

:::tip
Evaluation workflows work best when you already understand the basics of how Henio Agent handles conversations and tool calls. Run through the Beginner path first if you're new.
:::

### "I want to use it as a Python library"

Integrate Henio Agent into your own Python applications programmatically.
...
| **Environments & Evaluation** | Benchmark workflows and generate trajectory data | [Environments](/docs/developer-guide/environments) |
