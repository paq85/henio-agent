...
Henio Agent saves conversation trajectories in ShareGPT-compatible JSONL format
for use as training data, debugging artifacts, and evaluation datasets.
...
It follows the Henio function-calling prompt template with:
