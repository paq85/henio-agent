...
~/.henio/channel_directory.json.  The send_message tool reads this file for
...
DIRECTORY_PATH = get_henio_home() / "channel_directory.json"
...
def build_channel_directory(adapters: Dict[Any, Any]) -> Dict[str, Any]:
    ...
    for plat in Platform:
        ...
        if plat_name in _SKIP_SESSION_DISCOVERY or plat_name in platforms:
            continue
        if plat_name not in _SESSION_DISCOVERY_PLATFORMS:
            continue
...
def _build_from_sessions(platform_name: str) -> List[Dict[str, str]]:
    ...
    sessions_path = get_henio_home() / "sessions" / "sessions.json"
