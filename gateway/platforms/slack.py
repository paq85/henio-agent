...
class SlackAdapter(BasePlatformAdapter):
    ...
    async def connect(self) -> bool:
        ...
        tokens_file = get_henio_home() / "slack_tokens.json"
        ...
        try:
            ...
            @self._app.command("/henio")
            async def handle_henio_command(ack, command):
                await ack()
            ...
            for _action_id in (
                "henio_approve_once",
                "henio_approve_session",
                "henio_approve_always",
                "henio_deny",
            ):
                    ...
                    "elements": [
                        {
                            ...
                            "style": "primary",
                            "action_id": "henio_approve_once",
                            "value": session_key,
                        },
                        {
                            "type": "button",
                            "text": {"type": "plain_text", "text": "Allow Session"},
                            "action_id": "henio_approve_session",
                            "value": session_key,
                        },
                        {
                            "type": "button",
                            "text": {"type": "plain_text", "text": "Always Allow"},
                            "action_id": "henio_approve_always",
                            "value": session_key,
                        },
                        {
                            "type": "button",
    ...
    async def _handle_approval_action(self, ack, body, action) -> None:
        ...
        choice_map = {
            "henio_approve_once": "once",
            "henio_approve_session": "session",
            "henio_approve_always": "always",
            "henio_deny": "deny",
        }
    ...
    async def _handle_slash_command(self, command: dict) -> None:
        ...
        from henio_cli.commands import slack_subcommand_map
