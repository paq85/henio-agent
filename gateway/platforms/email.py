"""
Email platform adapter for the Henio gateway.

Allows users to interact with Henio by sending emails.
...
class EmailAdapter(BasePlatformAdapter):
    ...
    def _send_email(
        ...
        subject = ctx.get("subject", "Henio Agent")
        ...
        msg_id = f"<henio-{uuid.uuid4().hex[:12]}@{self._address.split('@')[1]}>"
