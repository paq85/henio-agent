...
class DiscordAdapter(BasePlatformAdapter):
    ...
    def __init__(self, config: PlatformConfig):
        ...
        self._text_batch_delay_seconds = float(os.getenv("HENIO_DISCORD_TEXT_BATCH_DELAY_SECONDS", "0.6"))
        self._text_batch_split_delay_seconds = float(os.getenv("HENIO_DISCORD_TEXT_BATCH_SPLIT_DELAY_SECONDS", "2.0"))
    ...
    def _register_slash_commands(self) -> None:
        ...
        @tree.command(name="reset", description="Reset your Henio session")
        ...
        @tree.command(name="status", description="Show Henio session status")
        ...
        @tree.command(name="stop", description="Stop the running Henio agent")
        ...
        @tree.command(name="update", description="Update Henio Agent to the latest version")
        ...
        @tree.command(name="thread", description="Create a new thread and start a Henio session in it")
        @discord.app_commands.describe(
            name="Thread name",
            message="Optional first message to send to Henio in the thread",
        ...
        try:
            from henio_cli.commands import discord_skill_commands
    ...
    async def _handle_thread_create_slash(
        ...
        # If a message was provided, kick off a new Henio session in the thread
    ...
    async def _create_thread(
        ...
        *,
        ...
        try:
            ...
            try:
                seed_content = starter_message or f"\U0001f9f5 Thread created by Henio: **{name}**"
    ...
    async def _auto_create_thread(self, message: 'DiscordMessage') -> Optional[Any]:
        ...
        thread_name = content[:80] if content else "Henio"
        if len(content) > 80:
    ...
    async def send_update_prompt(
        ...
        Used by the gateway ``/update`` watcher when ``henio update --gateway``
...
if DISCORD_AVAILABLE:
    ...
    class UpdatePromptView(discord.ui.View):
        """Interactive Yes/No buttons for ``henio update`` prompts.
