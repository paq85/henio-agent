...
PAIRING_DIR = get_henio_dir("platforms/pairing", "pairing")
...
class PairingStore:
    ...
    def __init__(self, pairing_dir: Path | None = None):
        self._pairing_dir = Path(pairing_dir) if pairing_dir is not None else PAIRING_DIR
