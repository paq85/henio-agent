...
Hooks are discovered from ~/.henio/hooks/ directories, each containing:
...
HOOKS_DIR = get_henio_home() / "hooks"
    ...
    def _register_builtin_hooks(self) -> None:
        ...
        try:
            ...
            self._loaded_hooks.append({
                "name": "boot-md",
                "description": "Run ~/.henio/BOOT.md on gateway startup",
        ...
        for hook_dir in sorted(HOOKS_DIR.iterdir()):
            ...
            try:
                ...
                spec = importlib.util.spec_from_file_location(
                    f"henio_hook_{hook_name}", handler_path
                )
